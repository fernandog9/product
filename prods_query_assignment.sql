...
SELECT prod_id, prod_desc, prod_quantity FROM product WHERE prod_quantity BETWEEN '12', '30';
SELECT prod_id, prod_desc, prod_quantity FROM product WHERE prod_quantity IN BETWEEN '12', '30';
...
SELECT prod_id, prod_desc, prod_quantity = prod_price AS TOTAL_VALUE FROM product WHERE prod_type >= '4000';
...
SELECT cust_balance FROM customer
WHERE cust_balance = '237' AND cust_balance < cust_limit;
...
SELECT rep_id FROM rep
WHERE cust_balance IS IN rep AND > '12000';
